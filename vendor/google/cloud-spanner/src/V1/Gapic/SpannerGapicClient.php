...
class SpannerGapicClient
{
    ...
    public function executeStreamingSql(
        ...
        $request = null;
        $requestParamHeaders = [];
        Tracer::inSpan(['name' => 'gapic_processing'], function () use(&$request, $session, $sql, &$requestParamHeaders, &$optionalArgs){
            $request = Tracer::inSpan(['name' => 'create_req'], function () use(&$request, $session, $sql, &$requestParamHeaders, &$optionalArgs){
        ...
        $resp = Tracer::inSpan(['name' => 'GAX->startCall'], function () use($optionalArgs, $request){
            return $this->startCall(
                'ExecuteStreamingSql',
        ...
        BaseStub::$logs[] = ['gapic_executeStreamingSql', 'Time taken by the GAPIC client', hrtime(true) - $start];
        return $resp;
    }
