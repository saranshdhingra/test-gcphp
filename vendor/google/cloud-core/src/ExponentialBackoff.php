...
class ExponentialBackoff
{
     ...
     */
    public function execute(callable $function, array $arguments = [], $shouldTrace = false)
    {
        ...
        while (true) {
            try {
                if ($shouldTrace) {
                    return Tracer::inSpan(['name' => 'GAPIC->executeStreamingSql'], function () use($function, $arguments){
